...
Rphi1 = Matrix(
    [[cos(phi0 + phi1), sin(phi0 + phi1)], [-sin(phi0 + phi1), cos(phi0 + phi1)]]
)
Rphi2 = Matrix([[cos(phi2), sin(phi2)], [-sin(phi2), cos(phi2)]])
Rphi3 = Matrix(
    [[cos(phi2 + phi3), sin(phi2 + phi3)], [-sin(phi2 + phi3), cos(phi2 + phi3)]]
)
...
r1 = Matrix(
    [
        x + l0 * sin(phi0) + s1 * sin(phi0 + phi1),
        y - l0 * cos(phi0) - s1 * cos(phi0 + phi1),
    ]
)
r4 = Matrix(
    [
        x + l0 * sin(phi0) + l1 * sin(phi0 + phi1),
...
r3 = Matrix(
    [
        x + l2 * sin(phi2) + s3 * sin(phi2 + phi3),
        y - l2 * cos(phi2) - s3 * cos(phi2 + phi3),
    ]
)
r5 = Matrix(
    [
        x + l2 * sin(phi2) + l3 * sin(phi2 + phi3),
