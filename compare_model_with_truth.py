...
my_model = MechanicalModel(dim_states=dim_state, dim_observations=dim_obs, imu_positions=imu_positions,
                           leg_constants=leg_constants, R=np.eye(dim_obs))
...
# ---------- plotting -----------------
supress_zeros = True
plot_observations(y_nonlinear=y_nonlinear, y_linear=y_linear, y_true=y, supress_zeros=supress_zeros, export_name=None)
